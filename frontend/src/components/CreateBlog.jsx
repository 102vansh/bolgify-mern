      ...
      <div className="container">
        <form onSubmit={handleBlog}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <img
              src={mainImagePreview ? `${mainImagePreview}` : "https://t4.ftcdn.net/jpg/02/17/88/73/360_F_217887350_mDfLv2ootQNeffWXT57VQr8OX7IvZKvB.jpg"}
              alt=""
              className="mainImg"
            />
            <input
          ...
          <div className="sub-para">
            ...
            <img
              src={
                paraOneImagePreview ? `${paraOneImagePreview}` : "https://t4.ftcdn.net/jpg/02/17/88/73/360_F_217887350_mDfLv2ootQNeffWXT57VQr8OX7IvZKvB.jpg"
              }
              alt="subParaOneImg"
            />
            <input
          ...
          <div className="sub-para">
            ...
            <img
              src={
                paraTwoImagePreview ? `${paraTwoImagePreview}` : "https://t4.ftcdn.net/jpg/02/17/88/73/360_F_217887350_mDfLv2ootQNeffWXT57VQr8OX7IvZKvB.jpg"
              }
              alt="subParaTwoImg"
            />
            <input
